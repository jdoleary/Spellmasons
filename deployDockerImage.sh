...
# cpln image build --dockerfile Dockerfile.bun --push --name $PUBLIC_IMAGE_PATH:$PACKAGE_VERSION
# cpln image build --dockerfile Dockerfile.bun --push --name $PUBLIC_IMAGE_PATH:latest
# echo "Pushed to Control Plane