...
declare global {
  ...
  var joinRoom:
    | undefined
    | ((_room_info: any, isHosting: boolean) => undefined | Promise<unknown>);
  ...
  var save:
    | undefined
    | ((title: string, forceOverwrite?: boolean) => Promise<string>);
  ...
  var changeVolume:
    | undefined
    | ((volume: number, saveSetting: boolean) => void);
  var changeVolumeMusic:
    | undefined
    | ((volume: number, saveSetting: boolean) => void);
  var changeVolumeGame:
    | undefined
    | ((volume: number, saveSetting: boolean) => void);
  ...
  var startSingleplayer:
    | undefined
    | ((numberOfHotseatPlayers: number) => Promise<void>);
  ...
  var superMe:
    | undefined
    | ((underworld: Underworld, player?: Player.IPlayer) => void);
  ...
  var attentionMarkers:
    | undefined
    | { imagePath: string; pos: Vec2; scale: number }[];
  ...
  var setRMBDown:
    | undefined
    | ((isDown: boolean, underworld: Underworld) => void);
  ...
  var setDifficulty:
    | undefined
    | ((gameMode: 'normal' | 'hard' | 'impossible') => void);
  ...
  var refreshSummonCardDescriptions:
    | undefined
  ...
  var setCinematicCameraEnabled:
    | undefined
    | ((enabled: boolean, saveSetting: boolean) => void);
  ...
  var update:
    ...
    | {
        onUpdateCounter: (
          callback: (
            _sender: any,
            updateState: { complete: boolean; error: string; progress: number },
          ) => void,
        ) => void;
      };
