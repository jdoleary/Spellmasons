...
export function makeForceMoveProjectile(args: ForceMoveProjectileArgs, underworld: Underworld, prediction: boolean): ForceMove {
  const { source, pushedObject, startPoint, endPoint, speed, doesPierce, ignoreUnitIds, collideFnKey } = args;
  ...
  const forceMoveInst: ForceMoveProjectile = { type: ForceMoveType.PROJECTILE, collideFnKey, ignoreUnitIds, doesPierce, source, pushedObject, startPoint, endPoint, velocity };
