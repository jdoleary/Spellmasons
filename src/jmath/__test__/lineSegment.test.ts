...
describe('lineSegment', () => {
  ...
  describe('isOnOutside', () => {
    [
      ...
      it(`should return ${expected} for ${point.x},${
        point.y
      } isOnOutside of  ${toString(l1)}`, () => {
  ...
  describe('isCollinearAndOverlapping', () => {
    [
      ...
      {
        description:
          'Horizontal lines that are collinear and one is large and they point in opposite directions',
        l1: {
          p1: {
            x: 0,
            y: 0,
      ...
      {
        description:
          'Horizontal lines that are collinear but NOT touching because they have a gap inbetween',
        l1: {
          p1: {
            x: 0,
            y: 0,
      ...
      {
        description:
          'Vertical lines that are collinear but NOT touching because they have a gap inbetween',
        l1: {
          p1: {
            x: 0,
            y: 0,
      ...
      {
        description:
          'lines that are overlapping but are pointing away from each other',
        l1: {
          p1: {
            x: 0,
            y: 0,
      ...
      {
        description:
          'lines that are NOT overlapping and are pointing away from each other',
        l1: {
          p1: {
            x: 0,
            y: 0,
  ...
  describe('findWherePointIntersectLineSegmentAtRightAngle', () => {
    it('should return the point if the point is on the line segment already', () => {
      ...
      const actual = findWherePointIntersectLineSegmentAtRightAngle(
        point,
        line,
      );
