...
const playerUnit: UnitSource = {
  ...
  info: {
    description:
      'You and your kin are Spellmasons: mighty wizards that forge magic with nothing but a bit of ingenuity and some mana.',
  ...
  action: async (
    ...
    if (attackTarget && canAttackTarget) {
      ...
      await Unit.playComboAnimation(unit, 'playerAttackSmall', keyMoment, {
        animationSpeed: 0.2,
        loop: false,
      });
    }
