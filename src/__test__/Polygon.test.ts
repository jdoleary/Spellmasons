...
describe('testables', () => {
    ...
    describe('isVec2InsidePolygon', () => {
        describe('corner cases', () => {
            ...
            it('should return false when point is outside and intersection is at a VERY shallow angle', () => {
                // This causes one intersection to be on a vertex and another to be ~ .00000000000002 away from
                // the vertext
            ...
            it('should return false when point is outside and intersection is at a VERY shallow angle - reverse order', () => {
                // Same as the above test but the intersections occur in reverse order
                const testPoint = { x: 64, y: 0 };
                const poly = {
                    points: [
                        { x: 362, y: 5 },
