...
<div id="cookie-consent" style="border:1px solid black; padding:4px; position:fixed;left:0;right:0;bottom:0;background-color:white;z-index:1;">
	<p>
	This website uses cookies and other browser storage technologies to store relevant information for playing Spellmasons such as your clientID (used to distinguish you from other online players), and the game state (which represents the information needed to play the game).
	</p>
	<div>
