...
export const sfx: { [key: string]: string[] } = {
    ...
    burst: ['./sound/sfx-4/Burst_v2.wav'],
    drown: ['./sound/sfx-4/Drown_v2.wav'],
    suffocate: ['./sound/sfx-4/Suffocate_v2.wav'],
    ...
    targetAquired0: ['./sound/sfx-4/Target_variation-001.wav'],
    targetAquired1: ['./sound/sfx-4/Target_variation-002.wav'],
    targetAquired2: ['./sound/sfx-4/Target_variation-003.wav'],
    targetAquired3: ['./sound/sfx-4/Target_variation-004.wav'],
    targeting: ['./sound/sfx-4/Targeting_v3.wav'],
