...
export const sfx: { [key: string]: string[] } = {
    ...
    targetAquired0: ['./sound/sfx-4/Target_V2-001.wav'],
    targetAquired1: ['./sound/sfx-4/Target_V2-001.wav'],
    targetAquired2: ['./sound/sfx-4/Target_V2-002.wav'],
    targetAquired3: ['./sound/sfx-4/TargetV2-002.wav'],
