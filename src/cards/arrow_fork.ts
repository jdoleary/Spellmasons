...
async function fireForkedArrows(
  state: EffectState,
  ...
  return raceTimeout(
    ...
    new Promise((resolve) => {
      ...
      for (let newAngle of [
        ...
        const angle =
          getAngleBetweenVec2s(state.casterUnit, firstTarget) + newAngle;
        const castLocation = getEndpointOfMagnitudeAlongVector(
          firstTarget,
          angle,
          10_000,
        );
        ...
        promises.push(
          arrowEffect(1, 10, undefined, true)(
            {
              ...state,
              casterPositionAtTimeOfCast: firstTarget,
              targetedUnits: [],
              casterUnit: firstTarget,
              castLocation,
            },
            regularArrow.card,
            1,
