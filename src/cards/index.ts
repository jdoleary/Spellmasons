...
// on first turn
import registerSummoningSickness from '../modifiers/summoningSickness';
import registerCorpseDecay from '../modifiers/corpseDecay';
import registerImmune, * as immune from './immune';
import registerImpendingDoom from '../modifiers/impendingDoom';
import registerSoulShardOwner from '../modifiers/soulShardOwner';
import registerUndying from '../modifiers/undying';
...
import registerPrimedCorpse from '../modifiers/primedCorpse';
import registerSlime from '../modifiers/slime';
import registerUnstable from '../modifiers/unstable';
import registerCurseImmunity from '../modifiers/curseImmunity';
import registerDoubleDamage from '../modifiers/doubleDamage';
import registerConfidence from '../modifiers/confidence';
import registerDefiance from '../modifiers/defiance';
import registerDamageLimiter from '../modifiers/damageLimiter';
import registerTargetImmune, { targetImmuneId } from '../modifiers/targetImmune';
import registerGrowth from '../modifiers/growth';
import registerModifierStatUpgrades from '../modifiers/statUpgrades';
import registerReroll from '../modifiers/reroll';
import registerDareDevil from '../modifiers/dareDevil';
import registerEndlessQuiver from '../modifiers/endlessQuiver';
import registerInexhaustible from '../modifiers/inexhaustible';
import registerAffinityBlessing from '../modifiers/affinityBlessing';
import registerAffinityCurse from '../modifiers/affinityCurse';
import registerAffinityDamage from '../modifiers/affinityDamage';
import registerAffinityMovement from '../modifiers/affinityMovement';
import registerAffinitySoul from '../modifiers/affinitySoul';
import registerAffinityTargeting from '../modifiers/affinityTargeting';
import registerFarGazerRune from '../modifiers/farGazer';
import registerGamblerRune from '../modifiers/gambler';
import registerAlchemist from '../modifiers/alchemist';
import registerGolemancer from '../modifiers/golemancer';
import registerNecromancerRune from '../modifiers/necromancer';
import registerTimemasonRune from '../modifiers/timemason';
import registerWitchRune from '../modifiers/witch';
import registerArmor from '../modifiers/armor';
import registerHealthRegen from '../modifiers/healthRegen';
import registerManaBarrier from '../modifiers/manaBarrier';
import registerOnHitHealing from '../modifiers/onHitHealing';
import registerOnHitPoison from '../modifiers/onHitPoison';
import registerOverheal from '../modifiers/overheal';
import registerRevitalize from '../modifiers/revitalize';
import registerSelfInvulnerability from '../modifiers/selfImmunity';
import registerShieldRegen from '../modifiers/shieldRegen';
import registerThorns from '../modifiers/thorns';
import registerBasePierce from '../modifiers/basePierce';
import registerBaseRadiusBoost from '../modifiers/baseRadiusBoost';
import registerContaminateSelfOnTeleport from '../modifiers/contaminateSelfOnTeleport';
import registerCloneOnSpawn from '../modifiers/cloneOnSpawn';
import registerCloneOnTeleport from '../modifiers/cloneOnTeleport';
import registerGoodLooking from '../modifiers/goodLooking';
import registerShieldBash from '../modifiers/shieldBash';
import registerOnKillMana from '../modifiers/onKillMana';
import registerBounty from '../modifiers/bounty';
import registerMoreBounties from '../modifiers/bountyMore';
import registerBountyHunter from '../modifiers/bountyHunter';
import registerBountyRefresh from '../modifiers/bountyRefresh';
import registerBountyRestoreStamina from '../modifiers/bountyRestoreStamina';
import registerBountyDamage from '../modifiers/bountyDamage';
import registerBountySuffocate from '../modifiers/bountySuffocate';
import registerBountyPotion from '../modifiers/bountyPotion';
import registerBountyPortal from '../modifiers/bountyPortal';
import registerBountyGolem from '../modifiers/bountyGolem';
import registerLiquidmancer from '../modifiers/liquidmancer';
import registerHeavyImpacts from '../modifiers/heavyImpact';
import registerSecretIngredients from '../modifiers/secretIngredients';
import registerPotionEffectiveness from '../modifiers/potionEffectiveness';
import registerPotionBarrier from '../modifiers/potionBarrier';
import registerCreepingDeath from '../modifiers/creepingDeath';
import registerPlagueBringer from '../modifiers/plagueBringer';
import registerHeavyToxins from '../modifiers/heavyToxins';
import registerOnKillResurrect from '../modifiers/onKillResurrect';
import registerMeleeSpecialist from '../modifiers/meleeSpecialist';
import registerBlackCoin from '../modifiers/blackCoin';
import registerLastStand from '../modifiers/lastStand';
import registerContaminateOnKill from '../modifiers/contaminateOnKill';
import registerHatOfDespair from '../modifiers/hatOfDespair';
import registerTownPortal from '../modifiers/townPortal';
import registerBloodLetting from '../modifiers/bloodLetting';
import registerInvestment from '../modifiers/investment';
import registerWintersChill from '../modifiers/wintersChill';
import registerIcyVeins from '../modifiers/icyVeins';
import registerBloodWarlock from '../modifiers/bloodWarlock';
import registerWitchBane from '../modifiers/witchBane';
import registerThornyDecoys from '../modifiers/thornyDecoys';
import registerSharpTeeth from '../modifiers/sharpTeeth';
import registerHardenedMinions from '../modifiers/hardenedMinions';
import registerReflex from '../modifiers/reflex';
import registerPlagueDoctor from '../modifiers/plagueDoctor';
import registerWhirlpool from '../modifiers/whirlpool';
import registerPrecision from '../modifiers/precision';
