...
// Milliseconds for average card execution per quantity
// Context: https://github.com/jdoleary/Spellmasons/issues/683#issuecomment-2120797899
// Note: for spells that executed relatively immediately, I've made the minimum timeout
// 10 ms
export const cardTimings: { [cardId: string]: number } = {
  "Undead Blade": 403,
  "FlameStrike": 399,
  "Vengeance": 10,
  "Vampire Bite": 402,
  ...
  "priest Miniboss": 10,
  "poisoner": 10,
  "poisoner Miniboss": 10,
  "vampire": 10,
  "vampire Miniboss": 10,
  "gripthulu": 10,
  "gripthulu Miniboss": 10,
  "summoner": 10,
  "summoner Miniboss": 10,
  "Blood Golem": 10,
  "Blood Golem Miniboss": 10,
  "Blood Archer": 10,
  "Blood Archer Miniboss": 10,
  "Ghost Archer": 10,
  "Ghost Archer Miniboss": 10,
  "Green Glop": 10,
  "Green Glop Miniboss": 10,
  "Mana Vampire": 10,
  "Mana Vampire Miniboss": 10,
  "Dark Summoner": 10,
  "Dark Summoner Miniboss": 10,
  "dark priest": 10,
  "dark priest Miniboss": 10,
  "Spellmason": 10,
  "Spellmason Miniboss": 10,
  "Deathmason": 2,
  "Deathmason Miniboss": 10,
  "Goru": 10,
  "Goru Miniboss": 10,
  "Ice Urn": 10,
  "Toxic Urn": 10,
